          ...
          children: [
            ...
            SizedBox(
              ...
              child: SettingsCard(
                ...
                onTap: () async {
                  try {
                    await Navigator.of(context).push(MaterialPageRoute(builder: (_) => const GmailInboxPage()));
                  } catch (e) {
                    if (kDebugMode) debugPrint('Error abriendo GmailInboxPage: $e');
                    if (mounted)
                      ScaffoldMessenger.of(context)
                          .showSnackBar(const SnackBar(content: Text('No se pudo abrir la bandeja de correos')));
                  }
                },
              ),
            ),
