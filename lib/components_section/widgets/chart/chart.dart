    ...
    return LayoutBuilder(builder: (ctx, constraints) {
      final maxAllowedHeight =
          constraints.maxHeight.isFinite && constraints.maxHeight > 0
              ...
              : double.infinity;
      final chartDesired = AwSize.s300;
      final containerHeight = math.min(chartDesired, maxAllowedHeight * 0.9);

      return Container(
        margin: const EdgeInsets.symmetric(horizontal: 8, vertical: 12),
        padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 6),
        width: double.maxFinite,
        height: containerHeight.isFinite ? containerHeight : chartDesired,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...List.generate(7, (index) {
                          double value = _maxTotalExpense -
                              (index * (_maxTotalExpense / 6));
                          return Align(
