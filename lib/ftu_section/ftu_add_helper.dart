                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            // Open the two options (same as pressing the FAB)
                            try {
                              // Open the new-expense screen directly and request
                              // it to run its FTU sequence.
                              Navigator.of(context).pushNamed('/new-expense', arguments: {'showFTUOnNewExpense': true});
                            } catch (_) {}
                          },
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AwSpacing.s6,
                          const AwText.normal('Pulsa el botón + para ver las dos opciones disponibles.',
